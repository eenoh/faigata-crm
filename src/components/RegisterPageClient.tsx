    ...
    <div className="relative">
      ...
      <label
        ...
        className={cn(
          ...
          "peer-focus:top-2.5 peer-focus:translate-y-0 peer-focus:text-[10px] peer-not-placeholder-shown:top-2.5 peer-not-placeholder-shown:translate-y-0 peer-not-placeholder-shown:text-[10px]",
